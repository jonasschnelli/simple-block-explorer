	    ...
	    <div class="collapse navbar-collapse" id="navbarSupportedContent">
	      ...
	      <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
	        ...
	        <li class="nav-item py-1 px-0 px-lg-2">
						<a href="https://github.com/jonasschnelli/simple-block-explorer" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#fff" class="bi bi-github" viewBox="0 0 16 16">
